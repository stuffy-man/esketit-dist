...
JEIEvents.hideItems((event) => {
  ...
  // ── TOOLS ────────────────────────────────────────────────────
  ["iron", "golden", "diamond", "netherite", "flint"].forEach((m) => {
    event.hide(`cosmeticweaponsmod:${m}_knife`);
  });
  event.hide("cosmeticweaponsmod:stone_knife");
  event.hide("cosmeticweaponsmod:wooden_knife");
  event.hide("cosmeticweaponsmod:bone_knife");
  event.hide("cosmeticweaponsmod:rose_gold_knife");
  event.hide("cosmeticweaponsmod:gilded_netherite_knife");
