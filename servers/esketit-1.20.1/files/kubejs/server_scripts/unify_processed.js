...
ServerEvents.recipes(event => {
    ...
    // ════ MEAD · Primary: brewinandchewin (dedicated brewing/alcohol mod) ════
    event.replaceInput({},  'hearthandharvest:mead', 'brewinandchewin:mead')
    event.replaceOutput({}, 'hearthandharvest:mead', 'brewinandchewin:mead')
    event.shapeless('brewinandchewin:mead', ['hearthandharvest:mead'])

    // ════ MELON JUICE · Primary: farmersdelight (TAN copy redundant — thirst disabled) ════
    event.replaceInput({},  'toughasnails:melon_juice', 'farmersdelight:melon_juice')
    event.replaceOutput({}, 'toughasnails:melon_juice', 'farmersdelight:melon_juice')
    event.shapeless('farmersdelight:melon_juice', ['toughasnails:melon_juice'])
})
